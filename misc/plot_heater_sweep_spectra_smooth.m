function plot_heater_sweep_spectra_smooth(spectra_results, heater_power, laser_power)
...
% laser_power: laser power in mW
    ...
    for i = 1:size(spectra_results,3)
        ...
        plot(spectra_results(1,:,i),lowpass(10*log10(spectra_results(2,:,i)./laser_power_W),0.25),...
            "DisplayName", name, ...
            "Color", color, ...
            "LineWidth", 2);
    end
