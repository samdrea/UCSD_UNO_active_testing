...
settle_time = 0.1; %0.1; % seconds. For voltage to stabilize while I collect data?
function_handle = @doNothing; %@get_agi_power; % Will be run everytime Keithley changes voltage 
